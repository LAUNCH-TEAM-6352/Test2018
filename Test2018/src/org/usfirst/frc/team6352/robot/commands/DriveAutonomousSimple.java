 ...
 */
public class DriveAutonomousSimple extends Command
{
	 ...
	 * @param timeoutKey
	 */
	public DriveAutonomousSimple(String speedKey, String curveKey, String timeoutKey)
	{
		this();
	 ...
	 * @param timeout
	 */
	public DriveAutonomousSimple(double speed, double curve, double timeout)
	{
		this();
		this.speed = speed;
		this.curve = curve;
