 ...
 */
public class MovePowerCubeLift extends Command
{
	...
	public MovePowerCubeLift()
	{
		requires(Robot.powerCubeLift);
	}
	
	public MovePowerCubeLift(String motorSpeedKey)
	{
		this();
		this.motorSpeedKey = motorSpeedKey;
	}
	
	public MovePowerCubeLift(double motorSpeed)
	{
		this();
